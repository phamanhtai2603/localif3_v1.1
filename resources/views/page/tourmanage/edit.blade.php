       ...
       @csrf
        <div class="row">
            ...
            <div class="p-4 mb-3 bg-white">
                ...
                <br>
                <div class="row form-group">
                    <div class="col col-md-3"><label for="active" class=" form-control-label">Status</label></div>
                    <div class="col-12 col-md-9">
                        <select name="status" class="form-control" data-parsley-trigger="change">
                            <option value="0" {{$tour->status == 0 ? 'selected': ''}}>Active</option>
                            <option value="1" {{$tour->status == 1 ? 'selected': ''}}>Invisible</option>
                        </select>
                    </div>
                </div>
