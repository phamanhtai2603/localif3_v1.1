              ...
              <div class="col-sm-8">
                  <div class="page-header float-right">
                      <div class="page-title">
                          ...
                          <li><a href="{{route('user.show',['id' => $user->id])}}">Chỉnh sửa người dùng</a></li>
                          </ol>
                      </div>
                  </div>
              </div>
                ...
                <div class="row">
                    <div class="col-8">
                        ...
                        <div class="row form-group">
                            ...
                            <input type="text" id="firstNameUserEdit" pattern="([a-zA-ZẮẰẲẴẶĂẤẦẨẪẬÂÁÀÃẢẠĐẾỀỂỄỆÊÉÈẺẼẸÍÌỈĨỊỐỒỔỖỘÔỚỜỞỠỢƠÓÒÕỎỌỨỪỬỮỰƯÚÙỦŨỤÝỲỶỸỴắằẳẵặăấầẩẫậâáàãảạđếềểễệêéèẻẽẹíìỉĩịốồổỗộôớờởỡợơóòõỏọứừửữựưúùủũụýỳỷỹỵ ]){2,}" name="first_name" value="{{$user->first_name}}" placeholder="Họ" class="form-control" data-parsley-trigger="change" required="" >
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="text" id="lastNameEdit" name="last_name" pattern="([a-zA-ZẮẰẲẴẶĂẤẦẨẪẬÂÁÀÃẢẠĐẾỀỂỄỆÊÉÈẺẼẸÍÌỈĨỊỐỒỔỖỘÔỚỜỞỠỢƠÓÒÕỎỌỨỪỬỮỰƯÚÙỦŨỤÝỲỶỸỴắằẳẵặăấầẩẫậâáàãảạđếềểễệêéèẻẽẹíìỉĩịốồổỗộôớờởỡợơóòõỏọứừửữựưúùủũụýỳỷỹỵ ]){2,}" value="{{$user->last_name}}" placeholder="Tên" class="form-control" data-parsley-trigger="change" required="" >
                        ...
                        <div class="row form-group">
                            <div class="col col-md-3"><label for="email-input" class=" form-control-label">Email đăng ký</label></div>
                            <div class="col-12 col-md-9">
                            <input type="text" id="email-input" name="email" value="{{$user->email}}"  class="form-control" data-parsley-trigger="change" required="" readonly>
                                @if($errors->has('email'))
                                    <small class="text-danger w-100">
                                        {{$errors->first('email')}}
                                    </small>
                      ...
                      <div class="row form-group">
                          ...
                          <div class="col-12 col-md-9">
                          <input type="text" id="text-input" name="phone_number" pattern="/((09|03|07|08|05)+([0-9]{8})\b)/g" value="{{$user->phone_number}}" placeholder="Số điện thoại" class="form-control" data-parsley-trigger="change">
                      ...
                      <div class="row form-group">
                          ...
                          <div class="col-12 col-md-9">
                                <select name="role" id="select" class="form-control" data-parsley-trigger="change">
                                    ...
                                    @elseif($user->role == 2)
                                    <option value="3">Khách hàng</option>
                                    <option value="2"selected>Hướng dẫn viên</option>
