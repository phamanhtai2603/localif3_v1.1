                ...
                <div class="row">
                    <div class="col-8">
                      ...
                      <div class="form-group" id="text-area">
                              ...
                              <div class=""><textarea name="content" id="editor" rows="13" cols="9" placeholder="Điều đặc biệt mà bạn muốn chia sẽ, điều đặc biệt làm nên chuyến đi của bạn" class="form-control" data-parsley-trigger="change" required="">{{ $tour->content }}</textarea></div>
